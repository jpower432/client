...
2. Use the `client build` command to build the workspace as an OCI artifact in build cache `default is (homedir/.uor/cache). Can be set with the UOR_CACHE environment variable`.
